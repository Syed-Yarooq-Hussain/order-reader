...
import { IServiceAccount } from '../interface/firebase';

const private_key: string = process.env.PRIVATE_KEY_ID!;
const client_email: string = process.env.CLIENT_EMAIL!;
const client_id: string = process.env.CLIENT_ID!;
const client_x509_cert_url: string = process.env.CLIENt_CERT_URL!;

let serviceAccountcred: any = {
  "type": "service_account",
  "project_id": "construyo-coding-challenge",
